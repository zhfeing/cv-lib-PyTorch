...
vgg16_url = "https://s3.amazonaws.com/amdegroot-models/vgg16_reducedfc.pth"
...
def vgg_300(pretrained: bool = True):
    return VGG16(pretrained, 300)


def vgg_512(pretrained: bool = True):
    return VGG16(pretrained, 512)
